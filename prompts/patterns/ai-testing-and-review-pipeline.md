...
Generated by AI during development. The prompt from `prompts/by-task/qa/test-generation.md` already covers this. The key change is making test generation **mandatory, not optional**:
